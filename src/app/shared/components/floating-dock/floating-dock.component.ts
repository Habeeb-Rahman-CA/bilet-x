...
@Component({
  ...
  template: `
    <div
      class="fixed bottom-10 left-1/2 -translate-x-1/2 z-40 flex items-center space-x-2 border border-neutral-800 bg-black px-3 py-2 text-xs select-none"
    >
      <!-- Edge Dock Brand Icon -->
      <div class="flex items-center space-x-2 border-r border-neutral-800 pr-3">
        <span class="h-2 w-2 rounded-full bg-white"></span>
        <span class="font-mono text-[11px] font-bold tracking-wider text-white uppercase">BILET-X</span>
      </div>
      ...
      >
        ...
        <kbd class="border border-neutral-700 bg-black px-1.5 py-0.5 font-mono text-[9px] text-neutral-400">
          Ctrl+K
        </kbd>
      </button>
