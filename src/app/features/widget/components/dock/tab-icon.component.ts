...
import { DockTab } from './dock.component';

/**
 * Renders the correct brand / lucide SVG for a given DockTab, at the
 * requested pixel size. Extracted so the dock buttons and the edit-mode
 * "+ add tab" popover can share one source of truth for tab iconography.
 *
 * Icons are picked by tab.id (or an override via tab.icon). Fill defaults
 * to currentColor so callers can tint via CSS.
 */
@Component({
  ...
  template: `
    ...
    <!-- Slack -->
    <svg
      *ngIf="tab.id === 'slack' || tab.icon === 'slack'"
      xmlns="http://www.w3.org/2000/svg"
      [attr.width]="size"
      [attr.height]="size"
      viewBox="0 0 24 24"
    ...
    <!-- Bilet AI -->
    <svg
      *ngIf="tab.id === 'ai' || tab.id === 'bilet-ai' || tab.icon === 'ai'"
      xmlns="http://www.w3.org/2000/svg"
      [attr.width]="size"
      [attr.height]="size"
      viewBox="0 0 24 24"
    ...
    <!-- Water -->
    <svg
      *ngIf="tab.id === 'water' || tab.icon === 'water'"
      xmlns="http://www.w3.org/2000/svg"
      [attr.width]="size"
      [attr.height]="size"
      viewBox="0 0 24 24"
    ...
    <!-- Spotify -->
    <svg
      *ngIf="tab.id === 'spotify' || tab.icon === 'spotify'"
      xmlns="http://www.w3.org/2000/svg"
      [attr.width]="size"
      [attr.height]="size"
      viewBox="0 0 24 24"
